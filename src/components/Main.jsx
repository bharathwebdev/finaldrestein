...
const Span = styled.span`
  ...
  ${props => props.let_1 && css`
  color: #279fda;
  `}

  ${props => props.let_2 && css`
  color:  #5bba47;
  `}
  ${props => props.let_3 && css`
  color: #ff565d;
  `}
  ${props => props.let_4 && css`
  color: #ca3e96;
  `}
      ...
      <HeaderBg className="header_bg  ">
        <HeaderMainText className="header_main_text ">
          <DresteinText className="drestein">
            <Span let_1>DR</Span>eam d
            <Span let_2>ES</Span>ign
            <br/>
            compete<Span let_3>TE</Span> w
            <Span let_4>IN</Span>
          </DresteinText>
        ...
        <Timer className="timer">
          <Span bold>12</Span><Span timer>days</Span> <Span bold>35</Span><Span timer>hrs</Span>
          <br /> <Span bold>45</Span><Span timer>mins</Span>
        </Timer>
      </HeaderBg>
